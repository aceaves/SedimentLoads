...
name <- data.frame(Sites)
name$Sites <- as.character(name$Sites)
...
# Data pulled form Hilltop has different time frequencies. The aggregate function is used to aggregate data to 15 minute intervals
